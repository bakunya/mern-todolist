...
const CopyIconError = ({ className = '', size = 20 }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" className={clsx(className, "bi bi-clipboard-x")} viewBox="0 0 16 16">
...
export default memo(CopyIconError)