...
const SignInForm = ({ onSubmit }) => {
    ...
    return (
        <FormContainer onSubmit={handleSubmit}>
            <h1 className="text-white max-w-fit -skew-x-6 -skew-y-2 p-2 bg-dark-green">Sign In</h1>
            ...
            <Button className="mt-5 max-w-fit ml-auto block" type="submit" title="Sign In" />
        </FormContainer>
    )
}
